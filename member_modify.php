...
if ($id) {
	...
	// 설정되지 않은 게시판일때 에러 표시
	if (!$setup['name']) {
		Error("생성되지 않은 게시판입니다.<br><br>게시판을 생성후 사용하십시요","window.close");
	}
}
...
<input type=hidden name=page value="<?=isset($page)?htmlspecialchars($page):''?>">
<input type=hidden name=id value="<?=isset($id)?htmlspecialchars($id):''?>">
<input type=hidden name=no value="<?=isset($no)?htmlspecialchars($no):''?>">
<input type=hidden name=select_arrange value="<?=isset($select_arrange)?htmlspecialchars($select_arrange):''?>">
<input type=hidden name=desc value="<?=isset($desc)?htmlspecialchars($desc):''?>">
<input type=hidden name=page_num value="<?=isset($page_num)?htmlspecialchars($page_num):''?>">
<input type=hidden name=keyword value="<?=isset($keyword)?htmlspecialchars($keyword):''?>">
<input type=hidden name=category value="<?=isset($category)?htmlspecialchars($category):''?>">
<input type=hidden name=sn value="<?=isset($sn)?htmlspecialchars($sn):''?>">
<input type=hidden name=ss value="<?=isset($ss)?htmlspecialchars($ss):''?>">
<input type=hidden name=sc value="<?=isset($sc)?htmlspecialchars($sc):''?>">
...
<table border=0 cellspacing=1 cellpadding=0 width=540>
  ...
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<?=htmlspecialchars($member['user_id'])?> &nbsp;(<?=date("Y년 m월 d일 H시 i분",$member['reg_date'])?>에 가입)</td>
  </tr>
        <tr>
  ...
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<?=htmlspecialchars($member['level'])?></td>
  </tr>        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
  <tr height=28 align=right>
     <td style=font-family:Tahoma;font-size:8pt;><b>Name&nbsp;</td>
     <td align=left>&nbsp;<input type=text name=name size=20 maxlength=20 value="<?=htmlspecialchars($member['name'])?>" style=border-color:#d8b3b3 class=input></td>
  </tr>        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
...
<?php } ?>
  ...
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=email size=40 maxlength=255 value="<?=htmlspecialchars($member['email'])?>" style=border-color:#d8b3b3 class=input>
  ...
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=homepage size=40 maxlength=255 value="<?=htmlspecialchars($member['homepage'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_icq'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=icq size=20 maxlength=20 value="<?=htmlspecialchars($member['icq'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_aol'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=aol size=20 maxlength=30 value="<?=htmlspecialchars($member['aol'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_msn'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=msn size=20 maxlength=250 value="<?=htmlspecialchars($member['msn'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_hobby'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=hobby size=40 maxlength=40 value="<?=htmlspecialchars($member['hobby'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_job'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=job size=20 maxlength=20 value="<?=htmlspecialchars($member['job'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_home_address'])) { ?> 
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=home_address size=40 maxlength=255 value="<?=htmlspecialchars($member['home_address'])?>" style=border-color:#d8b3b3 class=input><input type=button value='검색' class=input style=border-color:#d8b3b3 onclick=address_popup(1)>
...
<?php if(!empty($group_data['use_home_tel'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=home_tel size=20 maxlength=20 value="<?=htmlspecialchars($member['home_tel'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_office_address'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=office_address size=40 maxlength=255 value="<?=htmlspecialchars($member['office_address'])?>" style=border-color:#d8b3b3 class=input><input type=button value='검색' class=input style=border-color:#d8b3b3 onclick=address_popup(2)>
...
<?php if(!empty($group_data['use_office_tel'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=office_tel size=20 maxlength=20 value="<?=htmlspecialchars($member['office_tel'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if(!empty($group_data['use_handphone'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<input type=text name=handphone size=20 maxlength=20 value="<?=htmlspecialchars($member['handphone'])?>" style=border-color:#d8b3b3 class=input>
...
<?php if($member['picture']) { ?> <br>&nbsp;<img src="<?=htmlspecialchars($member['picture'])?>" border=0> <input type=checkbox name=del_picture value=1> 삭제 
<?php }
...
<?php if(!empty($group_data['use_comment'])) { ?>
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<textarea cols=40 rows=4 name=comment style=border-color:#d8b3b3 class=textarea><?=htmlspecialchars($member['comment'])?></textarea><br>&nbsp;
...
<?php } ?>
  ...
  <tr height=28 align=right>
     ...
     <td align=left>&nbsp;<?=($member["point1"]*10+$member["point2"])?> 점 ( 작성글수 : <?=htmlspecialchars($member["point1"])?>, 코멘트 : <?=htmlspecialchars($member["point2"])?> )</td>
  </tr>        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<tr height=30 bgcolor=#ffffff>
   <td align=center><?php if($member['no']>1) {?><a href="member_out.php?id=<?=urlencode($id)?>&group_no=<?=urlencode($group_no)?>" onclick="return confirm('탈퇴하시겠습니까?\n\n탈퇴를 하시면 모든 정보가 DB에서 사라집니다.\n\n탈퇴후 언제라도 재 가입가능합니다\n')"><img src=images/button_out.gif border=0 alt="회원탈퇴"></a><?php }?></td>
