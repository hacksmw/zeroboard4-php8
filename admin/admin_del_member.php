...
<form autocomplete="off" name=write method=post action=<?=$PHP_SELF?> enctype=multipart/form-data onsubmit="return confirm('<?=del_html(stripslashes($data['name']))?> 회원을 하시겠습니까?')">
