...
function showImageBox(id) {
	imageBoxHandler = window.open("image_box.php?id="+escape(id),"imageBox","width=600,height=540,resizable=yes,scrollbars=yes,toolbars=no");
}
...
function check_use_html(obj) {
 ...
 function show_waiting() {
	...
	var zb_waiting = document.getElementById("zb_waiting");
...
function hide_waiting() {
	var zb_waiting = document.getElementById("zb_waiting");
	var check_attack = document.check_attack;
