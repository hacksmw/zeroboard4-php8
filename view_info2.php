...
<?php if($data['open_picture'] && $data['picture']) { ?>
  <tr><td align="right" valign="top"><img src="images/t.gif" height="1"><br><img src="images/vi_photo.gif" align="absmiddle">&nbsp;&nbsp;</td><td align="left">&nbsp;<img src="<?=htmlspecialchars($data['picture'])?>" border="0"></td></tr>
        <tr>
...
<?php if($data['open_homepage']&&$data['homepage']) { ?>
  <tr><td align="right"><img src="images/vi_homepage.gif" align="absmiddle">&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><a href="<?=htmlspecialchars($data['homepage'])?>"  target=_blank><?=htmlspecialchars($data['homepage'])?></a></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['open_icq']&&$data['icq']) {?>
  <tr><td align=right><img src=images/vi_icq.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['icq'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['open_aol']&&$data['aol']) {?>
  <tr><td align=right><img src=images/vi_aim.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['aol'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['open_msn']&&$data['msn']) {?>
  <tr><td align=right><img src=images/vi_msn.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['msn'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['open_hobby']&&$data['hobby']) {?>
  <tr><td align=right><img src=images/vi_hobby.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['hobby'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['job']&&$data['open_job']) {?>
  <tr><td align=right><img src=images/vi_job.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['job'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['home_address']&&$data['open_home_address']) {?>
  <tr><td align=right valign=top><img src=images/t.gif height=1><br><img src=images/vi_address.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['home_address'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['home_tel']&&$data['open_home_tel']) {?>
  <tr><td align=right><img src=images/vi_phone.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['home_tel'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['open_office_address']&&$data['office_address']) {?>
  <tr><td align=right valign=top><img src=images/t.gif height=1><br><img src=images/vi_address.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['office_address'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['open_office_tel']&&$data['office_tel']) {?>
  <tr><td align=right><img src=images/vi_phone.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['office_tel'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
...
<?php if($data['open_handphone']&&$data['handphone']) {?>
  <tr><td align=right><img src=images/vi_cellular.gif align=absmiddle>&nbsp;&nbsp;</td><td align=left><img src="images/t.gif" width="10" height="3"><br><?=htmlspecialchars($data['handphone'])?></td></tr>
        <tr>
          <td colspan="5" bgcolor="#EBD9D9" align="center"><img src="images/t.gif" width="10" height="1"></td>
        </tr>
<?php } ?>
