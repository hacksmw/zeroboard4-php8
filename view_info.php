...
<tr>
  ...
  <td valign="bottom">&nbsp;<font color="brown"><b><?=del_html($data['user_id'])?> (<?=$data['name']?>)</b></font></td>
</tr>
<?php
 } else {
?>
...
<tr>
  <td align="right">
  <img src="images/memo_id.gif">
  </td>
  <td valign="bottom">&nbsp;<font color="brown"><b><?=htmlspecialchars($data['user_id'])?> (<?=$data['name']?>)</b></font></td>
</tr>
<?php } ?>


<tr>
  <td align="right"><input type="hidden" name="kind" value="0"><img src="images/sm_from.gif"></td>
